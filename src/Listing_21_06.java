...
public class Listing_21_06 {
    ...
    public static void main(String[] args) {
        ...
        // Create a linked has set, and test its performance
        Collection<Integer> set2 = new LinkedHashSet<>(list);
        System.out.println("Member test time for linked has set is " + getTestTime(set2) + " milliseconds");
